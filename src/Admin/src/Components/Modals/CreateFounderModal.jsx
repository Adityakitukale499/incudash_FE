...
export default function CreateFounderModal
    ({ open, handleClose, create, founderName, setFounderName, designation, setDesignation, company, setCompany, price, setPrice, imageRef, setImageRef }) {
                ...
                <Fade in={open}>
                    <Box sx={style}>
                        ...
                        <Box id="transition-modal-description" sx={{ m: 4}}>
                            <Typography sx={{ mb: -2, fontSize: 12, fontWeight: 'bold' }}>Founder's Name</Typography>
                            <TextField
                            ...
                            <div className="update-btn">
                                <Button variant="contained" sx={{m : 2 }} onClick={create}>
                                    Create
                                </Button>
                            </div>
                            <div className="close">
